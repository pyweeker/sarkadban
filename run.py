...
class GameView(arcade.View):
    ...
    def setup(self, level):
        ...
        self.topleft_corner = arcade.tilemap.process_layer(map_object=my_map,
        ...
        self.diamond_zone_list = arcade.tilemap.process_layer(map_object=my_map,
                                                      layer_name=diamond_zone_layer_name,
                                                      scaling=TILE_SCALING,
                                                      use_spatial_hash=True)
        ...
        #self.static_box_list = arcade.SpriteList()
        self.diamond_list = arcade.tilemap.process_layer(map_object=my_map,
                                                      layer_name=diamonds_layer_name,
                                                      scaling=TILE_SCALING,
                                                      use_spatial_hash=True)


        self.troll_list = arcade.tilemap.process_layer(map_object=my_map,
                                                      layer_name=trolls_layer_name,
                                                      scaling=TILE_SCALING,
                                                      use_spatial_hash=True)
        ...
        self.static_diamond_list = arcade.tilemap.process_layer(map_object=my_map,
    ...
    def on_key_press(self, key, modifiers):
        ...
        if key == arcade.key.NUM_0: # SAVE IT
            ...
            #row = (playerY - topleftY) / (GRID_PIXEL_SIZE * TILE_SCALING)
            ...
            # fill with zeros to reset to clean old positions that could have moved since last time
            modiflist = [0 for i in range(grid_width * grid_height)] 

            print(f" fill zeros  modiflist {modiflist} ")

            # give the news positions            
