...
class GameView(arcade.View):
    ...
    def on_key_press(self, key, modifiers):
        ...
        if key == arcade.key.NUM_5:
            ...
            troll_sprites = self.tile_map.sprite_lists["Trolls_layer"]
            print(" +++ ")
            print(troll_sprites)
            print(dir(troll_sprites))
            print(troll_sprites._sprite_index_data)
            print(troll_sprites[0])
            ...
            for troll_sprite in troll_sprites:
                print(troll_sprite.guid)
                print(troll_sprite.__dict__)

                #troll_sprite.guid = data_granit[self.troll_list.index(troll_sprite)]
                troll_sprite.guid = data_granit[self.tile_map.sprite_lists["Trolls_layer"].index(troll_sprite)]
        ...
        if key == arcade.key.NUM_0: # SAVE IT
            ...
            # self.tile_map.sprite_lists[trolls_layer_name]

            print(self.topleft_corner)
            print(dir(self.topleft_corner))

            #topleftX = self.topleft_corner[0].center_x
            #topleftY = self.topleft_corner[0].center_y
            

            topleft = self.tile_map.sprite_lists["Topleft_corner_layer"][0]
            topleftX = topleft.center_x
            topleftY = topleft.center_y
            ...
            for box in self.tile_map.sprite_lists["Static_boxes_layer"]:
